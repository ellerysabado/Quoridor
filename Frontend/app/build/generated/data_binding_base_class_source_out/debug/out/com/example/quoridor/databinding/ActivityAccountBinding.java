...
public final class ActivityAccountBinding implements ViewBinding {
  ...
  private ActivityAccountBinding(@NonNull ConstraintLayout rootView, @NonNull TextView IDText,
      @NonNull Button logoutButton, @NonNull TextView usernameText) {
  ...
  public static ActivityAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAccountBinding((ConstraintLayout) rootView, IDText, logoutButton,
          usernameText);
    }
